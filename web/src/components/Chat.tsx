    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-border bg-panel p-4">
        <textarea
          ...
          rows={3}
          className="w-full resize-none rounded-lg border border-border bg-bg p-3 text-sm outline-none focus:border-accent"
      ...
      {status && <div className="rounded-lg border border-good/40 bg-good/10 p-3 text-sm text-good break-all">{status}</div>}
